...
| `test-full.sh` | Run workflow pinning, repo-specific Go source checks, Actionlint, generated drift, Go, errcheck, staticcheck, govulncheck, web smoke, and Android test gates. |
