...
type FeedItem struct {
	...
	AuthorAccountRegion      string
	AuthorAccountDetailsJSON string
	BodyText                 string
	ArticleTitle             string
	PollJSON                 string
	...
	QuoteAccountRegion       string
	QuoteAccountDetailsJSON  string
	QuoteBodyText            string
	QuoteArticleTitle        string
	QuotePollJSON            string
	QuoteCommunityNote       string
	QuoteLang                string
