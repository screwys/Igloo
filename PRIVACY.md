...
- YouTube, TikTok, X (and fxtwitter), Instagram, SponsorBlock, Unavatar (for YouTube search and Discover avatars, and as an Instagram avatar fallback) and maybe some I missed. You can also enable auto-translate for X posts, and select a provider (or connect to your self-hosted node).
